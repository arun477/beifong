...
const PonyoChatIcon = ({ 
  ...
  return (
    ...
    >
      ...
      <div 
        className={`absolute inset-0 rounded-full overflow-hidden transition-transform duration-300 ease-in-out ${isLoading ? '' : 'enhanced-float'}`}
        style={{
   ...
   return (
      <div className="mb-6 flex items-center p-4 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl fade-in">
         <div className="w-12 h-12 relative flex-shrink-0 mr-4">
            <PonyoChatIcon size={48} isLoading={true} />
         </div>
