...
def get_latest_asset_url(owner, repo, asset_name):
    """query github api for the latest release asset download url."""
...
def main():
    ...
    for d in TARGET_DIRS:
        ensure_empty(d)
    url = get_latest_asset_url(OWNER, REPO, ASSET_NAME)
