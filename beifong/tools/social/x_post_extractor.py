...
if __name__ == "__main__":
    html_file_path = "x_sample.html"
    if os.path.exists(html_file_path):
        with open(html_file_path, "r", encoding="utf-8") as file:
            html_content = file.read()
        extracted_data = x_post_extractor(html_content)
